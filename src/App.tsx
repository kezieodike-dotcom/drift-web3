  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'glass py-3' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 rounded-full text-sm font-semibold transition-all active:scale-95 shadow-[0_0_20px_rgba(37,99,235,0.3)] group">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-2xl font-light leading-relaxed text-white/80 relative z-10">
    ...
    <section id="solution" className="py-32 bg-white/[0.02]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Introducing DRIFT HUB</h2>
        ...
        <div className="flex flex-col items-center gap-10">
          <div className="flex items-center gap-12 text-white/30 font-bold tracking-widest uppercase text-sm">
            <span>Built on:</span>
          ...
          <div className="text-center italic text-white/60 text-lg">
...
const AIEngineSection = () => {
  return (
    <section id="ai-engine" className="py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-20">
          ...
          >
            ...
            <h2 className="text-5xl font-display font-bold mb-8 italic">Intelligence That <br /> Builds With You</h2>
            ...
            <button className="px-10 py-5 bg-blue-600 hover:bg-blue-500 rounded-2xl font-bold flex items-center gap-2 transition-all shadow-[0_0_30px_rgba(37,99,235,0.2)]">
...
const LaunchpadSection = () => {
  return (
    <section id="launchpad" className="py-32 bg-blue-600 text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-display font-bold mb-8">Launch With Transparency</h2>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-10 py-5 bg-white text-blue-600 rounded-2xl font-bold hover:bg-blue-50 transition-all shadow-xl">
                Launch a Project
              </button>
              <button className="px-10 py-5 bg-blue-700 text-white rounded-2xl font-bold hover:bg-blue-800 transition-all border border-blue-400/30">
          ...
          <div className="relative">
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass bg-white/10 p-2 rounded-[2rem] border-white/20 shadow-2xl"
            >
              <div className="bg-[#050505] rounded-[1.8rem] overflow-hidden aspect-[4/5] p-8">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-blue-600 rounded-lg" />
                    <div>
                      <h4 className="font-bold text-sm underline decoration-blue-500">Project Orion</h4>
                      <p className="text-[10px] text-white/40 uppercase tracking-widest">AI Compute Layer</p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                      <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold mb-1">Raised</p>
                      <p className="text-lg font-bold">450k <span className="text-xs text-blue-400">USDC</span></p>
                    </div>
                    <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                      <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold mb-1">Backers</p>
                  ...
                  <div className="p-4 rounded-xl bg-blue-600/10 border border-blue-500/20">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-[10px] uppercase tracking-widest font-bold text-blue-400">Current Milestone</span>
                    </div>
                    <p className="text-xs font-medium">Phase 1: Neural Engine Alpha Release</p>
                  </div>

                  <button className="w-full py-4 bg-white text-black rounded-xl font-bold text-sm tracking-tight active:scale-[0.98] transition-transform">
                    Invest Now
                  </button>
                </div>
              </div>
    ...
    <section id="token" className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl font-display font-bold mb-6 italic">Fuel the Ecosystem. <br /> Own the Future.</h2>
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                className="glass p-8 rounded-[2rem] border border-white/5 bg-white/[0.03] transition-all"
              >
            ...
            <div className="col-span-2">
              <button className="w-full py-5 bg-white text-black rounded-2xl font-bold hover:bg-blue-50 transition-all flex items-center justify-center gap-3 active:scale-[0.99]">
...
const SystemArchitecture = () => {
  ...
  return (
    <section id="architecture" className="py-32 bg-[#080808] border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <h2 className="text-5xl font-display font-bold mb-6 italic tracking-tighter">System Architecture</h2>
          <p className="text-white/50 text-lg max-w-2xl leading-relaxed italic">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-3 space-y-2">
            {flows.map((flow, i) => (
              <button
                ...
                className={`w-full p-6 rounded-2xl text-left transition-all flex items-center gap-4 ${activeStep === i ? 'bg-blue-600 text-white shadow-xl translate-x-2' : 'glass text-white/40 hover:text-white hover:bg-white/5'}`}
              >
                <flow.icon size={20} />
                <div>
                  <h4 className="font-bold text-sm tracking-tight">{flow.title}</h4>
                  <p className={`text-[10px] leading-tight mt-1 ${activeStep === i ? 'text-white/70' : 'text-white/20'}`}>{flow.desc}</p>
                </div>
              </button>
            ))}
          </div>
          ...
          {/* Visual Container */}
          <div className="lg:col-span-9 bg-[#050505] rounded-[3rem] p-1 border border-white/5 shadow-2xl min-h-[500px] flex flex-col overflow-hidden">
            <div className="flex items-center gap-2 p-6 border-b border-white/5 bg-white/[0.02]">
              ...
              <span className="text-[10px] font-mono text-white/20 ml-4 font-bold tracking-widest uppercase">drift_system_visualizer_v3.1</span>
            </div>

            <div className="flex-1 p-12 relative flex items-center justify-center overflow-hidden">
              <AnimatePresence mode="wait">
                {activeStep === 0 && (
                  <motion.div
                    ...
                    className="w-full h-full flex flex-col md:flex-row items-center justify-between gap-8 relative"
                  >
                    {[
                      ...
                      <React.Fragment key={i}>
                        <div className="flex flex-col items-center gap-4 relative z-10 group">
                          <div className="w-20 h-20 glass rounded-[2rem] flex items-center justify-center text-blue-400 group-hover:scale-110 transition-transform group-hover:border-blue-500/40">
                            <step.icon size={32} />
                          </div>
                          <div className="text-center">
                            <h5 className="font-bold text-xs">{step.label}</h5>
                ...
                {activeStep === 1 && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -20 }}
                    className="w-full max-w-2xl bg-black/50 rounded-2xl p-8 font-mono text-xs border border-white/5"
                  >
                    <div className="flex items-center gap-2 mb-6 text-white/20 border-b border-white/5 pb-4">
                      <Terminal size={14} />
                ...
                {activeStep === 2 && (
                  ...
                  >
                    {[
                      ...
                      <div key={i} className="glass p-8 rounded-3xl text-center border-blue-500/10 hover:border-blue-500/40 transition-all group">
                        <div className="w-16 h-16 bg-blue-600/10 rounded-2xl flex items-center justify-center text-blue-400 mx-auto mb-6 group-hover:scale-110 transition-transform">
                          <box.icon size={28} />
                        </div>
                        <h5 className="font-bold text-sm mb-2">{box.label}</h5>
              ...
              <div className="flex flex-wrap gap-8 justify-center">
                {[
                  ...
                  <div key={i} className="flex flex-col items-center">
                    <span className="text-[9px] uppercase tracking-widest text-white/20 font-bold mb-1">{stat.label}</span>
                    <span className="text-xs font-bold text-white/60">{stat.val}</span>
                  </div>
                ))}
              </div>
            </div>
...
const GovernanceSection = () => {
  return (
    <section id="governance" className="py-32 border-y border-white/5 bg-white/[0.01]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-display font-bold mb-8 uppercase tracking-tighter italic">Govern What <br /> You Build</h2>
            ...
            <div className="flex items-center gap-6 mb-10">
              <div className="text-center px-8 border-r border-white/10">
                <p className="text-3xl font-bold font-display">152</p>
                <p className="text-[10px] text-blue-400 uppercase tracking-widest font-bold">Proposals</p>
              </div>
              <div className="text-center px-8">
                <p className="text-3xl font-bold font-display">42.5M</p>
                <p className="text-[10px] text-blue-400 uppercase tracking-widest font-bold">Staked DRFT</p>
              </div>
            </div>
            <button className="px-10 py-5 bg-white text-black rounded-2xl font-bold hover:bg-blue-50 transition-all active:scale-95 shadow-xl flex items-center gap-2 group">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="glass p-6 rounded-2xl flex items-center justify-between border-blue-500/10 hover:border-blue-500/30 transition-all group">
                <div>
                  <h4 className="font-bold text-sm mb-1 group-hover:text-blue-400 transition-colors">{item.title}</h4>
                  <p className="text-[11px] text-white/30 uppercase tracking-[0.1em] font-bold">{item.status}</p>
                </div>
                <div className="text-right">
                  <p className="text-xs font-bold text-white/50">{item.vote}</p>
                </div>
              </div>
            ))}
            <div className="p-8 bg-blue-600/5 rounded-3xl border border-blue-500/10 text-center italic text-white/40">
              "Real power. On-chain."
            </div>
          </div>
        </div>
...
const NFTSection = () => {
  return (
    <section id="nft" className="py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-5xl font-display font-bold mb-6 italic">Proof of Contribution</h2>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-20">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="glass p-1 rounded-[2.5rem] border-white/10 group cursor-pointer"
            >
              <div className="bg-[#050505] rounded-[2.3rem] aspect-square flex flex-col items-center justify-center p-8 relative overflow-hidden">
                <div className={`absolute inset-0 bg-current opacity-0 group-hover:opacity-5 transition-opacity ${item.color}`} />
                <div className="relative z-10 p-5 rounded-full glass border-white/5 group-hover:border-blue-500/20 transition-all mb-6 group-hover:rotate-12">
                  <item.icon size={48} className={`${item.color}`} />
                </div>
                <h4 className="font-bold text-center tracking-tighter mb-1 relative z-10">{item.label} Badge</h4>
                <p className="text-[10px] text-white/30 font-mono relative z-10 uppercase tracking-widest italic">ID: #DRFT-REP-{item.id}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex items-center gap-4 text-xs font-bold tracking-[0.2em] text-white/30 uppercase">
            <span>Stored via:</span>
            <div className="flex items-center gap-2 text-white/60">
              <Box size={14} /> <span>IPFS</span>
            </div>
          </div>
          <button className="px-12 py-5 bg-blue-600/10 border border-blue-500/20 text-blue-400 rounded-2xl font-bold hover:bg-blue-600/20 transition-all active:scale-95 flex items-center gap-2">
...
const HowItWorksSection = () => {
  return (
    <section className="py-32 bg-white/[0.02] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl font-display font-bold text-center mb-20 italic">Three Steps to Enter the Future</h2>
        ...
        <div className="mt-20 text-center">
          <button className="px-14 py-6 bg-white text-black rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-2xl active:scale-95">
            Get Started Now
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="text-5xl font-display font-bold mb-12 italic tracking-tighter">Why We Win</h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 bg-white/[0.03] p-4 rounded-xl border border-white/5">
                  ...
                  <span className="font-bold text-xs tracking-widest uppercase text-white/70">{text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-10">
            <motion.p
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="text-4xl font-light italic text-white/20 leading-tight"
            >
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="text-6xl font-display font-bold text-blue-400 tracking-tighter"
            >
...
const RoadmapSection = () => {
  ...
  return (
    <section id="roadmap" className="py-32 bg-white/[0.01] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-20 gap-8">
          <div>
            ...
            <h2 className="text-6xl font-display font-bold italic tracking-tighter">The Road Ahead</h2>
          </div>
          <button className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 hover:text-white transition-all glass px-6 py-3 rounded-full hidden md:block border-white/10">
        ...
        <div className="space-y-4">
          {phases.map((phase) => (
            <motion.div
              ...
              className="glass p-8 rounded-[2.5rem] flex flex-col md:flex-row items-start md:items-center gap-8 group hover:bg-white/[0.05] transition-all border-white/5 cursor-default"
            >
              <div className="text-6xl font-display font-bold text-blue-600/10 group-hover:text-blue-500/20 transition-colors w-24">
                0{phase.num}
              </div>
              <div className="flex-1">
                <h4 className="font-bold text-xl uppercase tracking-widest mb-1 italic">Phase {phase.num}</h4>
                <p className="text-lg text-white/50 font-light">{phase.desc}</p>
              </div>
              <div className={`px-6 py-2 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] transition-all border ${phase.num === 1 ? 'bg-blue-600 text-white border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.3)]' : 'bg-white/5 text-white/30 border-transparent group-hover:border-white/10'}`}>
...
const FinalCTASection = () => {
  return (
    <section className="py-40 relative overflow-hidden bg-blue-650">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        <motion.h2
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="text-6xl md:text-9xl font-display font-bold tracking-tighter text-white mb-12 italic"
        >
          The Future <br /> Doesn’t Wait.
        </motion.h2>
        <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-16 leading-relaxed font-light italic">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="w-full sm:w-auto px-14 py-7 bg-white text-blue-700 rounded-3xl font-bold text-xl hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all active:scale-95">
            Enter DRIFT HUB
          </button>
          <button className="w-full sm:w-auto px-14 py-7 glass bg-white/5 text-white border-white/20 rounded-3xl font-bold text-xl hover:bg-white/10 transition-all active:scale-95">
            Join the Community
          </button>
        </div>
      </div>
...
export default function App() {
  return (
    <div className="min-h-screen font-sans bg-[#050505] text-white selection:bg-blue-600 selection:text-white">
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-16 mb-24">
            <div className="col-span-2 space-y-10">
              <div className="flex items-center gap-2">
                <div className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center font-bold text-3xl shadow-xl">D</div>
                <span className="font-display font-bold text-3xl tracking-tighter">DRIFT HUB</span>
              </div>
              <p className="text-white/30 max-w-sm text-lg leading-relaxed italic font-light">
                Decentralized Intelligence Infrastructure.
                <br /><br />
              ...
              <div className="flex gap-6">
                {['Twitter', 'Discord', 'Telegram', 'Github'].map(social => (
                  <a key={social} href="#" className="w-14 h-14 glass rounded-2xl flex items-center justify-center hover:bg-white/10 hover:translate-y-[-4px] transition-all border-white/5">
                    <span className="sr-only">{social}</span>
                    <div className="w-6 h-6 bg-white/10 rounded-[6px]" />
                  </a>
                ))}
              </div>
            </div>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 text-[9px] text-white/10 uppercase tracking-[0.4em] font-bold italic">
